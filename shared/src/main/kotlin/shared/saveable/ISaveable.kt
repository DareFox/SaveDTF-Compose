...
sealed interface ISaveable {
     ...
     *
     * [ERROR] - Shows that element operation has failed. Usually set with [an error message][ISaveable.lastErrorMessage]
     *
    ...
    enum class Status {
        ...
        /**
         * Shows that element operation has failed. Usually set with [an error message][ISaveable.lastErrorMessage]
         */
        ERROR,
