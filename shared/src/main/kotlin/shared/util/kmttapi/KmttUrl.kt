...
object KmttUrl {
    ...
    private fun getIdOrNullSample() {
        ...
        getMediaIdOrNull(validURL) // 118ce574-1507-5a19-92a0-6b06da18fdf3

        val noSlashURL = "https://leonardo.osnova.io/118ce574-1507-5a19-92a0-6b06da18fdf3"
        getMediaIdOrNull(noSlashURL) // 118ce574-1507-5a19-92a0-6b06da18fdf3

        val invalidURL = "https://osnova.io/118ce574-1507-5a19-92a0-6b06da18fdf3"
        getMediaIdOrNull(invalidURL) // null
    }
    ...
    fun getMediaId(url: String): String {
        val value = getMediaIdOrNull(url)
    ...
    private fun getIdSample() {
        val validURL = "https://leonardo.osnova.io/118ce574-1507-5a19-92a0-6b06da18fdf3/"
        getMediaId(validURL) // 118ce574-1507-5a19-92a0-6b06da18fdf3

        val noSlashURL = "https://leonardo.osnova.io/118ce574-1507-5a19-92a0-6b06da18fdf3"
        getMediaId(noSlashURL) // 118ce574-1507-5a19-92a0-6b06da18fdf3

        val invalidURL = "https://osnova.io/118ce574-1507-5a19-92a0-6b06da18fdf3"
        getMediaId(invalidURL) // IllegalArgumentException
    }
